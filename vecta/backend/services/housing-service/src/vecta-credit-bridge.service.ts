...
export class VectaCreditBridge {
  ...
  private async fetchFromBureau(bureauName: string, student: {
    ...
    switch (bureauName) {
      case 'CIBIL': {
        const { CIBILAdapter } = await import('../../../shared/providers/src/adapters/cibil.adapter');
      ...
      case 'BURO_DE_CREDITO': {
        const { BuroDeCreditoAdapter } = await import('../../../shared/providers/src/adapters/buro-de-credito.adapter');
      ...
      case 'EXPERIAN_UK': {
        const { ExperianUKAdapter } = await import('../../../shared/providers/src/adapters/experian-uk.adapter');
      ...
      case 'EQUIFAX_CANADA': {
        const { EquifaxCanadaAdapter } = await import('../../../shared/providers/src/adapters/equifax-canada.adapter');
